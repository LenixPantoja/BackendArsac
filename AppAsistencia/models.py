...
class AsistenciaEstudiante(models.Model):
     ...
     soporte = models.ImageField(upload_to='imageSoportes/', null=True, default="Sin registro")
...
class AsistenciaParticipante(models.Model):
     ...
     descripcion = models.TextField(null=True, default="Sin registro")
     hora_llegada = models.DateTimeField()   
     soporte = models.ImageField(upload_to='imagenes/', null=True, default="Sin registro")
