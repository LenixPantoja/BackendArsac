...
class Docente(models.Model):
     user = models.OneToOneField(User, verbose_name="UsuarioDocente", on_delete=models.CASCADE)
     docente_profesion = models.ForeignKey(Profesion, verbose_name="Profesion", on_delete=models.CASCADE)
...
class Estudiante(models.Model):
     ...
     user = models.OneToOneField(User, verbose_name="UsuarioEstudiante",on_delete=models.CASCADE)
...
class Participante(models.Model):
     user = models.OneToOneField(User, verbose_name="UsuarioParticipante", on_delete=models.CASCADE)
     ...
     # participante_fecha_nac = models.DateField()
